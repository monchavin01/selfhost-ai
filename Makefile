...
ADMIN       := ./scripts/admin
PROFILES    := fast coder reason smart qwen3
...
help:
	...
	@echo "    make switch P=coder    Activate a profile: fast | coder | reason | smart | qwen3 | off"
	...
	@echo "    make qwen3             Same as: make switch P=qwen3  (Qwen3-32B, 24GB+ VRAM)"
